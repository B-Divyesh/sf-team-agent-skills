...
export type Skill = {
  ...
  repositories: string[]; approved_by: string | null; approved_at: string | null; approval_id?: string | null;
};
export type Receipt = {
...
export const sampleSkills: Skill[] = [
  { id:'secure-commit', name:'Secure commit', version:'2.4.0', summary:'Check secrets, tests, and change notes before a commit.', targets:['Codex','Claude Code'], ring:'all', updated:'28 Aug', owner:'Mina Patel', secrets:['GITHUB_TOKEN'], instructions:'Inspect the staged diff. Stop if it contains a credential. Run the repository test command and require a change note.', adapters:{Codex:'Use AGENTS.md project instructions.', 'Claude Code':'Use CLAUDE.md project instructions.'}, git_url:'https://github.com/example/agent-skills', git_commit:commit, source_verified_at:'2026-08-27T14:00:00Z', package_digest:'11a207a732e90e3ecb4d54c1b310babe0f666f1a2f43d005177550006047d1c0', package_signature:'1'.repeat(128), signer_public_key:'2'.repeat(64), repositories:['atlas-api','web-console'], approved_by:'Nora Singh', approved_at:'2026-08-27T14:20:00Z', approval_id:'apr-7f3a' },
  { id:'migration-review', name:'Migration review', version:'1.8.1', summary:'Review schema changes and require a rollback note.', targets:['Codex','Cursor'], ring:'pilot', updated:'27 Aug', owner:'Luis Chen', secrets:[], instructions:'Review each migration for locking risk. Require a tested rollback note before approval.', adapters:{Codex:'Read migrations and AGENTS.md.', Cursor:'Apply the repository rule file.'}, git_url:'https://github.com/example/agent-skills', git_commit:commit, package_digest:'15dd05aa671acbc838c1fe402180e490bfebdb36e75a08f8f6f0c70a2ef61826', repositories:['atlas-api'], approved_by:'Mina Patel', approved_at:'2026-08-26T12:00:00Z' },
  { id:'incident-note', name:'Incident note', version:'0.9.0', summary:'Draft a clear incident update from a checked timeline.', targets:['Claude Code'], ring:'review', updated:'26 Aug', owner:'Ari Cole', secrets:['STATUSPAGE_TOKEN'], instructions:'Use only confirmed timeline entries. Mark unknown causes as under investigation.', adapters:{'Claude Code':'Use the incident template in CLAUDE.md.'}, git_url:'https://github.com/example/agent-skills', git_commit:commit, package_digest:'28de4626f55e4a864d98ce080fca558072309285d03a55eeb5fa61f7580782c6', repositories:['web-console'], approved_by:'Luis Chen', approved_at:'2026-08-26T09:15:00Z' }
];
